...
C_SRCS += \
../ARM_src/Core/protocol/Secure/sha1/sha1.c 

OBJS += \
./ARM_src/Core/protocol/Secure/sha1/sha1.o 

C_DEPS += \
./ARM_src/Core/protocol/Secure/sha1/sha1.d 


# Each subdirectory must supply rules for building sources it contributes
ARM_src/Core/protocol/Secure/sha1/%.o: ../ARM_src/Core/protocol/Secure/sha1/%.c
	@echo 'Building file: $<'
