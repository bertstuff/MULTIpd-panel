...
PT_THREAD(_RFID_Set_Unlock_Code(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Write_Data(reader, &reader->reader_com.com_status, UNLOCK_CODE_BLOCK ,KeyA ,0 ,(char *)hash));
	printf("RFID: write lock ");
	if(reader->reader_com.com_status == SUCCESS){
...
PT_THREAD(_RFID_Get_Unlock_Code(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Read_Data(reader, &reader->reader_com.com_status, UNLOCK_CODE_BLOCK,KeyA,0,card_data));
	if(reader->reader_com.com_status == ERROR){
		PT_EXIT(&RFID_pass_pt);
	}
...
PT_THREAD(_RFID_Set_Info(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Write_Data(reader, &reader->reader_com.com_status, INFO_BLOCK ,KeyA ,0 ,card_data));
...
PT_THREAD(_RFID_Get_Info(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Read_Data(reader, &reader->reader_com.com_status, INFO_BLOCK,KeyA,0,card_data));
...
PT_THREAD(_RFID_Set_Credit(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Write_Data(reader,&reader->reader_com.com_status, CREDIT_BLOCK ,KeyA ,0 ,card_data_encrypt));
...
PT_THREAD(_RFID_Get_Credit(RFID_reader_t * reader, process_event_t ev, process_data_t data))
{
	...
	PT_SPAWN(&RFID_pass_pt,&pt_RFID_send_data,RFID_Read_Data(reader, &reader->reader_com.com_status, CREDIT_BLOCK ,KeyA ,0 ,card_data_encrypt));
