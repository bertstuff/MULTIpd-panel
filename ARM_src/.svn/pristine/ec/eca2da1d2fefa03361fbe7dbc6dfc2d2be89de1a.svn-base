...
void RTP_init(void){
	g_Devices_available.Payter_available = ini_getbool("Device","PayMate_available",false,"PayMate available:",inifile_device);
	if(g_Devices_available.Payter_available == false){
		return;
	}
	RTP_busy = true;
