...
Status  TG2460H_Init(UART_select_t Com){
	Status dev_stat;
	g_Devices_available.Printer_available = ini_getbool("Device","Printer_available",false,"Printer available:",inifile_device);
	if(g_Devices_available.Printer_available == false){
		return ERROR;
	}
	TG2460H_Uart = Com;
