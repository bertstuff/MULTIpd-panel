...
extern const char inifile_machine[];
extern const char inifile_device[];
extern const char inifile_net[];
...
int   ini_getbool(const mTCHAR *Section, const mTCHAR *Key, int DefValue, const TCHAR *Description, const mTCHAR *Filename);
long  ini_getl(const mTCHAR *Section, const mTCHAR *Key, long DefValue, const TCHAR *Description, const mTCHAR *Filename);
int   ini_gets(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *DefValue, const TCHAR *Description, mTCHAR *Buffer, int BufferSize, const mTCHAR *Filename);
int   ini_getsection(int idx, mTCHAR *Buffer, int BufferSize, const mTCHAR *Filename);
int   ini_getkey(const mTCHAR *Section, int idx, mTCHAR *Buffer, int BufferSize, const mTCHAR *Filename);

#if defined INI_REAL
INI_REAL ini_getf(const mTCHAR *Section, const mTCHAR *Key, INI_REAL DefValue, const TCHAR *Description, const mTCHAR *Filename);
#endif

#if !defined INI_READONLY
int   ini_putDateTime(const TCHAR *Section, const TCHAR *Key, struct tm *Value, const TCHAR *Description, const TCHAR *Filename);
int   ini_putl(const mTCHAR *Section, const mTCHAR *Key, long Value, const TCHAR *Description, const mTCHAR *Filename);
int   ini_puts(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, const TCHAR *Description, const mTCHAR *Filename);
#if defined INI_REAL
int   ini_putf(const mTCHAR *Section, const mTCHAR *Key, INI_REAL Value, const TCHAR *Description, const mTCHAR *Filename);
#endif
#endif /* INI_READONLY */
