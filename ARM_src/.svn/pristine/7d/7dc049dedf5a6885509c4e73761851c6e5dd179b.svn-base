...
static mxml_node_t	*mxml_load_data(mxml_node_t *top, void *p,
			                mxml_load_cb_t cb,
			                _mxml_getc_cb_t getc_cb,
                                        mxml_sax_cb_t sax_cb, void *sax_data, bool stream_end);
           ...
           mxml_load_cb_t cb)		/* I - Callback function or MXML_NO_CALLBACK */
{
  ...
  */
  ...
  return (mxml_load_data(top, &buf, cb, mxml_fd_getc, MXML_NO_CALLBACK, NULL, true));
}
             ...
             mxml_load_cb_t cb)		/* I - Callback function or MXML_NO_CALLBACK */
{
  ...
  */
  ...
  return (mxml_load_data(top, fp, cb, mxml_file_getc, MXML_NO_CALLBACK, NULL,true));
}
               ...
               mxml_load_cb_t cb)	/* I - Callback function or MXML_NO_CALLBACK */
{
  ...
  */
  ...
  return (mxml_load_data(top, (void *)&s, cb, mxml_string_getc, MXML_NO_CALLBACK, NULL, true));
}
              ...
              void           *sax_data)	/* I - SAX user data */
{
  ...
  */
  ...
  return (mxml_load_data(top, &buf, cb, mxml_fd_getc, sax_cb, sax_data, true));
}
    ...
    void           *sax_data)		/* I - SAX user data */
{
  ...
  */
  ...
  return (mxml_load_data(top, fp, cb, mxml_file_getc, sax_cb, sax_data, true));
}
...
mxmlSAXLoadString(
    ...
    mxml_sax_cb_t  sax_cb,		/* I - SAX callback or MXML_NO_CALLBACK */
    void           *sax_data,		/* I - SAX user data */
    bool stream_end) 				/*end of stream */
{
 /*
  * Read the XML data...
  */

  return (mxml_load_data(top, (void *)&s, cb, mxml_string_getc, sax_cb, sax_data, stream_end));
}
	...
	*/
	...
	else if ((ch & 0xe0) == 0xc0)
	{
	  ...
	  */
	  ...
	  if ((temp = _mxml_getc(fp)) == EOF || (temp & 0xc0) != 0x80)
	    return (EOF);
	...
	*/
        ...
        else if (ch >= 0xd800 && ch <= 0xdbff)
	{
	  ...
	  */
          ...
          int lch = _mxml_getc(fp);
          lch = (lch << 8) | _mxml_getc(fp);
...
{
  return (_mxml_putc(ch, (FILE *)p) == EOF ? -1 : 0);
}
