...
#include <Driver/include/lpc17xx_emac.h>
#include <Driver/include/lpc17xx_clkpwr.h>
...
#include <Driver/include/lpc17xx_libcfg.h>
#else
#include <Driver/include/lpc17xx_libcfg_default.h>
...
/** Rx buffer data */
__BSS(RAM2) static uint32_t rx_buf[EMAC_NUM_RX_FRAG][EMAC_ETH_MAX_FLEN>>2];
/** Tx buffer data */
__BSS(RAM2) static uint32_t tx_buf[EMAC_NUM_TX_FRAG][EMAC_ETH_MAX_FLEN>>2];
