...
C_SRCS += \
../ARM_src/Core/Math/PID.c \
../ARM_src/Core/Math/random.c 

OBJS += \
./ARM_src/Core/Math/PID.o \
./ARM_src/Core/Math/random.o 

C_DEPS += \
./ARM_src/Core/Math/PID.d \
./ARM_src/Core/Math/random.d 


# Each subdirectory must supply rules for building sources it contributes
ARM_src/Core/Math/%.o: ../ARM_src/Core/Math/%.c
	@echo 'Building file: $<'
