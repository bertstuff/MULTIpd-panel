...
/*prototype*/
PROCESS(MULTIpd_main_process, "main process");
...
/**
 * Changed this SCR_Idle_process to generic process as it does not do any screen related work
 */
PROCESS_THREAD(MULTIpd_main_process, ev, data)
{
